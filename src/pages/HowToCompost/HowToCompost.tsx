               ...
               <div className="bg-green-main bg-opacity-20 rounded-lg p-3 flex flex-col gap-y-2">
                  <ol className="ml-7 text-sm">
                     ...
                     <li>
                        ...
                        gardening supplies store, or if possible, make one
                        yourself (see links below).
                     </li>
                     <li>
                        4) Using a shovel, prepare an area for your composter by
                        turning the soil, preferably in a sunny, well-drained
                        area.
                     </li>
                     <li>
                        5) Cover the bottom of the area with a 2 to 3-inch layer
                        (5 to 6 cm) of small, dry branches.
                     </li>
                     <li>
                        6) On these branches, place a layer of dry leaves (the
                        disposable palm leaf plates and bowls can also be used
                        here effectively). This step will allow for air
                        circulation and it will also improve drainage, thus
                        helping to prevent the bottom from getting waterlogged.
                     </li>
                     <li>
                        7) Place 2 parts of the carbon-rich matter (brown or dry
                        matter, including the disposable wooden cutlery and palm
                        leaf plates) to 1 part of the nitrogen-rich matter
                        (green or wet matter).
                     </li>
                     <li>
                        {" "}
                        ...
                        the flies out of the compost bin. Some will also do this
                        to add the necessary bacteria, similar to adding starter
                        to a batch of yogurt.
                     </li>
                     <li>
                        9) You should aerate the compost pile using an aerator
                        or a pitch fork once a week.
                     </li>
                     <li>
                        10) Check the degree of humidity of your compost pile
                        from time to time. If it is dry, you can add water to
                        the compost until the degree of humidity is similar to
                        that of a wrung-out sponge (not a sponge that would let
                        out water if you wring it out). Be very careful with
                        adding water. A little water can go a long way… it is
                        always easier to add water than to remove it!
                     </li>
                  </ol>
               </div>
