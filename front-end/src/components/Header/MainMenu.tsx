   ...
   return (
      <>
         {mobileWidth ? (
            ...
            <nav className="z-20 w-full text-center items-center justify-between flex font-semibold 2xl:text-xl lg:text-base gap-x-6 sticky top-0 bg-white rounded-b-xl">
               {navLinks.map(({ to, text }) => (
                  <NavLink
                     key={uuidv4()}
                     to={to}
