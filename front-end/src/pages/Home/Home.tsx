...
export default function Home() {
   ...
   const FSC = () => {
      return (
         <div
            className={`border border-black rounded-2xl p-4 flex flex-col items-center justify-center gap-y-4 float-left ${
   ...
   return (
      <section className={`flex flex-col gap-y-3`}>
         ...
         <div className={`${mobileWidth ? "text-xs" : "text-lg"}`}>
            <p>
               <b>The products:</b> Our disposable, biodegradable, and
               compostable wooden cutlery is <b>100% natural</b> and is made of
               birch wood while our eco-friendly palm leaf plates and bowls are
               made from fallen palm leaves. These wooden knives can cut steak,
               and the wooden forks can handle salads. Eco-Gecko disposable
               cutlery and tableware all work well with hot or cold foods. There
               are <b>no coatings, waxes, or chemicals</b> of any sort added to
               our naturally beautiful tableware. Therefore, all of our
               disposable tableware products are <b>free</b> of toxicants and
               are accepted at all composting facilities on the basis of being
               composed of <b>completely organic</b> material.
            </p>
            ...
            {!mobileWidth && (
               <div
                  className="border-green-main border-1 p-4 float-right"
                  style={{
                     float: "right",
                     objectFit: "contain",
                     marginLeft: "10px",
            ...
            <p>
               <b>The reason:</b> Biodegradable and compostable wooden cutlery
               and palm leaf tableware by Eco-Gecko were designed to provide an{" "}
               <b>eco-friendly alternative</b> to the non-biodegrading
               disposable plastic cutlery and Styrofoam plates used so commonly
               in the food industry. Not only are these disposable
               petroleum-based utensils, plates, and bowls not biodegradable or
               compostable, but they often end up in landfills, polluting
               oceans, or even killing animals when they mistake these for food.
            </p>

            <br />

            <p>
               <b>The “eco”:</b> Just how eco-friendly is our disposable
               tableware? Eco-Gecko disposable wooden cutlery are made from{" "}
               <b>FSC-certified birch wood</b>. What does this mean? It means
               that the FSC (Forest Stewardship Council) recognizes and
               certifies that the methods of harvesting and re-planting are
               being <b>managed sustainably.</b>
            </p>
         </div>
         ...
         <p className={`${mobileWidth ? "text-xs" : "text-lg"}`}>
            ...
            whether you are planning an office party, an outdoor event, a dinner
            party, or for daily use in your office or restaurant, our
            ...
            <b>completely safe</b> for children to use. No toxins, no chemicals,
            just high-quality disposable tableware… made from natural and
            renewable resources.
         </p>
         ...
         <div>
            {!mobileWidth && (
               <div
                  className="border-green-main border-1"
                  style={{
                     float: "left",
                     objectFit: "contain",
                  }}
               >
                  <img src={palmLeafPlates} alt="palm Leaf Plates" />
               </div>
            )}
            <p>
               With something this <b>beautiful</b> and this <b>strong</b>, you
               will be surprised that our palm leaf plates are designed for one
               use. Their <b>natural beauty and strength</b> make them the
               perfect single-use tableware, no matter what you plan to serve on
               them. The plates are engineered to be more than durable, and the
               bowls can hold hot soup with ease. Our palm leaf plates and bowls
               are <b>green and mean</b>... So go ahead and load them up!
            </p>
            ...
            <p>
               ...
               <b>take-out</b> restaurants… and from <b>wineries</b> to office{" "}
               <b>lunch rooms</b>... The list of places that are already
               enjoying our biodegradable and compostable dinnerware is nearly
               endless. Wherever a fully functional yet eco-friendly disposable
               utensil or plate is needed, you can find us. Come on,{" "}
               <b>everyone’s doing it</b>…
            </p>
         </div>
         ...
         <span>
            {!mobileWidth && (
               ...
               >
                  <img src={woodenKsf} alt="wooden cutlery" />
               </div>
            )}
            <p>
               <b>The purchase:</b> Buying Eco Gecko biodegradable and
               compostable tableware has never been easier! Whether you are
               looking to put the finishing touches on your decor with the
               warming, natural palette of our wooden cutlery and classic palm
               leaf plates and bowls, or are interested in spicing up your table
               with plates featuring customized logos and designs, our sales
               ...
               plates and bowls to find a style and size to suit your needs!
            </p>
            <br />
            <p>
               <b>The options:</b> Looking for something unique? Want to make
               that holiday party more festive, or memorialize that event?
               Consider adding a customizable design to your plates and bowls!
               Using a process called "hot stamping," our talented staff can
               design and craft a stamping die which will safely add that unique
               touch to our palm leaf plates and bowls. Choose from our pre-made
               festive designs, or discuss your own design ideas with our
               helpful staff.{" "}
               <a
                  href="/contact-us"
                  target="_blank"
